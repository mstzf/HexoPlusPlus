...
function hpp_del(id) {
    swal({ title: "\n删除中...", icon: "https://pic.mstzf.cn/cdn/hpp/img/loading.gif", text: "\n", button: false, closeModal: false, });
    var ajax = ajaxObject();
...
function hpp_vi(id) {
    swal({ title: "\n修改中...", icon: "https://pic.mstzf.cn/cdn/hpp/img/loading.gif", text: "\n", button: false, closeModal: false, });
    var ajax = ajaxObject();
...
function readFile() {
    swal({ title: "\n上传中...", icon: "https://pic.mstzf.cn/cdn/hpp/img/loading.gif", text: "\n", button: false, closeModal: false, });
